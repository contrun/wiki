...
See [[https://www.wireguard.com/netns/][Routing & Network Namespaces]], [[https://unix.stackexchange.com/questions/149293/feed-all-traffic-through-openvpn-for-a-specific-network-namespace-only][Feed all traffic through OpenVPN for a specific network namespace only]]
for example usage of wireguard and openvpn in network namespace.
** VPN in userspace
...
See [[https://fly.io/blog/our-user-mode-wireguard-year/][Our User-Mode WireGuard Year]] for some example usage.
